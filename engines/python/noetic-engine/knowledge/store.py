...
class KnowledgeStore:
    def __init__(self, db_url: str = "sqlite:///:memory:", vector_db_path: Optional[str] = None):
        self.db_url = db_url
        ...
        self.collection = self.chroma_client.get_or_create_collection(name="knowledge_facts")
    ...
    def ingest_fact(self, subject_id: UUID, predicate: str, object_entity_id: Optional[UUID] = None, object_literal: Optional[str] = None) -> Fact:
        ...
        try:
            ...
            doc_text = f"{subject_id} {predicate} {obj_str}"
